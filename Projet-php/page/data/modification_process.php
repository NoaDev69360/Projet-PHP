...
if (!empty($_POST) && isset($_POST['account_nom']) && isset($_POST['account_prenom']) && isset($_POST['account_sexe']) && isset($_POST['account_email']) && isset($_POST['account_adresse']) && isset($_POST['account_permis']) && isset($_POST['account_tel']) && isset($_POST['account_date'])) {
    ...
    $date_naissance_c = $_POST['account_date'];
        ...
        // $stmt->execute([$_SESSION['id_c'], $email_c, $prenom_c, $sexe_c, $adresse_c, $numero_permis_c, $numero_telephone_c, $date_naissance_c]);
        // $client = $stmt->fetch();
        ...
        $stmt->execute([$email_c, $nom_c, $prenom_c, $sexe_c, $adresse_c, $numero_permis_c, $numero_telephone_c, $date_naissance_c, $_SESSION['id_c']]);
        $modif = $stmt->fetch();

        // Mettre à jour les variables de session si l'utilisateur est connecté
            $_SESSION['email'] = $email_c;
            $_SESSION['nom'] = $nom_c;
            $_SESSION['prenom'] = $prenom_c;
            $_SESSION['sexe'] = $sexe_c;
            $_SESSION['adresse'] = $adresse_c;
            $_SESSION['permis'] = $numero_permis_c;
}
?>
